            ...
            <div className='mt-12'>
              <div className='flex flex-wrap lg:flex-nowrap 
                ...
                <div className= 'bg-white dark:text-gray-200
                                  ...
                                  p-8 pt-4 m-3 bg-hero-pattern bg-no-repeat
                                  bg-cover bg-right-top drop-shadow-lg'>
                  <div className='flex justify-between items-center'>
                    <div>
                      <p className='font-bold
                      text-gray-500'>Earnings</p>
                      <p className='text-4xl'>$69,420.69</p>
                    </div>
                  </div>
                  <div className='mt-6'>
                  <Button 
                                      ...
                                      <div className='flex justify-between'>
                                        ...
                                        <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                                          ...
                                          border-color m-4 pr-10'>
                                            <div>
                                              <p>
                                                <span className='text-3xl font-semibold'>$69,420.69</span>
                                                <span className='p-2
                                            ...
                                            <div className='mt-8'>
                                              <p>
                                                <span className='text-3xl font-semibold'>$49,420.69</span>
                                              </p>
